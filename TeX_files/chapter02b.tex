...
\end{figure}
\section{Conclusions}
In this  chapter it was shown how the methods described in chapter \ref{chap:fresnel} can be implemented in the simulation toolbox. The performance of the different free space propagation methods evaluated using the results from the simulations were presented. 
